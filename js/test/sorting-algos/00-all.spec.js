const algos = require('../../src/algos/sorting-algos/index');
...
describe("Sorting Algorithms Suite:", () => {
    test("binary_search(sorted_array, value) should work", () => {
        expect(algos.BinarySearch(in_order, 1)).toEqual(1);
        expect(algos.BinarySearch(in_order, 16)).toEqual(16);
    });
    ...
    test("quick_sort(array) should work if array.length > 1, else should return array", () => {
        const ordered = algos.QuickSort(random_order2);
    ...
    test("bubble_sort(array) should work if array.length > 1, else should return array", () => {
        const ordered = algos.BubbleSort(random_order);
        expect(ordered).toEqual(in_order);
    });
